...
<figure class="wp-block-image aligncenter size-full"><img src="<?= get_parent_theme_file_uri('public/media/logo.png') ?>" alt="" class="wp-image-8"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"metadata":{"name":"Team Card"},"className":"is-style-section-cards-card","layout":{"type":"constrained"}} -->
<div class="wp-block-group is-style-section-cards-card"><!-- wp:image {"id":8,"sizeSlug":"full","linkDestination":"none","align":"center","className":""} -->
<figure class="wp-block-image aligncenter size-full"><img src="<?= get_parent_theme_file_uri('public/media/logo.png') ?>" alt="" class="wp-image-8"/></figure>
<!-- /wp:image -->
